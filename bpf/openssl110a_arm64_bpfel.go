...
type Openssl110aSpecs struct {
	...
	Openssl110aMapSpecs
	Openssl110aVariableSpecs
}

// Openssl110aProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl110aVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl110aVariableSpecs struct {
...
// Openssl110aVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl110aObjects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl110aVariables struct {
