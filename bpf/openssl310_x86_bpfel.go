...
type Openssl310Specs struct {
	...
	Openssl310MapSpecs
	Openssl310VariableSpecs
}

// Openssl310ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl310VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl310VariableSpecs struct {
...
// Openssl310Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl310Objects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl310Variables struct {
