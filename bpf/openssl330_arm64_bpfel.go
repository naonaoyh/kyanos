...
type Openssl330Specs struct {
	...
	Openssl330MapSpecs
	Openssl330VariableSpecs
}

// Openssl330ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl330VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl330VariableSpecs struct {
...
// Openssl330Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl330Objects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl330Variables struct {
...
//
//go:embed openssl330_arm64_bpfel.o
