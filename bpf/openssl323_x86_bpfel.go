...
type Openssl323Specs struct {
	...
	Openssl323MapSpecs
	Openssl323VariableSpecs
}

// Openssl323ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl323VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl323VariableSpecs struct {
...
// Openssl323Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl323Objects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl323Variables struct {
