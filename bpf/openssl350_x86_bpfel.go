...
type Openssl350Specs struct {
	...
	Openssl350MapSpecs
	Openssl350VariableSpecs
}

// Openssl350ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl350VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl350VariableSpecs struct {
...
// Openssl350Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl350Objects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl350Variables struct {
...
//
//go:embed openssl350_x86_bpfel.o
