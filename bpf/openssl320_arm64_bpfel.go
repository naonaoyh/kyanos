...
type Openssl320Specs struct {
	...
	Openssl320MapSpecs
	Openssl320VariableSpecs
}

// Openssl320ProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl320VariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl320VariableSpecs struct {
...
// Openssl320Variables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl320Objects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl320Variables struct {
