...
type Openssl111dSpecs struct {
	...
	Openssl111dMapSpecs
	Openssl111dVariableSpecs
}

// Openssl111dProgramSpecs contains programs before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
...
// Openssl111dVariableSpecs contains global variables before they are loaded into the kernel.
//
// It can be passed ebpf.CollectionSpec.Assign.
type Openssl111dVariableSpecs struct {
...
// Openssl111dVariables contains all global variables after they have been loaded into the kernel.
//
// It can be passed to LoadOpenssl111dObjects or ebpf.CollectionSpec.LoadAndAssign.
type Openssl111dVariables struct {
...
//
//go:embed openssl111d_arm64_bpfel.o
